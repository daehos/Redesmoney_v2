...
<head>
    ...
    <title>Administrator - {{ config('app.name', 'REDESMONEY') }}</title>
    <link rel="icon" type="image/png" sizes="20x20" href="{{ asset('gambar/sistem/logo.jpg')}}">
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header bg-white text-center">
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    <!-- <b class="logo-abbr"><img src="{{ asset('gambar/sistem/logo.jpg')}}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('gambar/sistem/logo.jpg') }}" alt=""></span> -->
                    <span class="brand-title">
                        <!-- <img src="{{ asset('gambar/sistem/logo.jpg')}}" alt="" style="height: 30px">  -->
                        <span class="text-white ml-2">REDES<b>MONEY</b></span>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="nk-sidebar">           
        ...
        <div class="p-3 profil_admin">
            <div class="media align-items-center mb-1 mt-3">
               @if(Auth::user()->foto == "")
               <img class="mr-2 rounded-circle" src="{{ asset('gambar/sistem/user.png')}}" height="60" width="60" alt="">
               @else
               <img class="mr-2 rounded-circle" src="{{ asset('gambar/user/'.Auth::user()->foto) }}" height="60" width="60">
               @endif
